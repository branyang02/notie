...
and reference $\eqref{eq:gaussian-integral}$ in the text.

Or we can have code blocks:
...
This is a placeholder image, with link to [placeholder.com](https://placeholder.com).
